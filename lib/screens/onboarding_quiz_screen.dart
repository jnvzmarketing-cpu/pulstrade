...
class OnboardingQuizScreen extends StatefulWidget {
  ...
  OnboardingQuizScreen({super.key, required this.onDone});
...
class _State extends State<OnboardingQuizScreen> with TickerProviderStateMixin {
  ...
  double? _avgRR;
  int? _totalSignals;
  static final _backendUrl = 'https://pulstrade-backend-production.up.railway.app';
    ...
    switch (_step) {
        ...
        return _choiceStep(
          ...
          options: [
            _Opt(
              ...
              title: 'Sniper',
              subtitle:
                  AppLocalizations.of(context).sniperDesc,
              badge: AppLocalizations.of(context).recommended,
              selected: _profile.mode == TradeMode.sniper,
              onTap: () =>
                  setState(() => _profile = _profile.copyWith(mode: TradeMode.sniper)),
            ),
            _Opt(
              ...
              onTap: () =>
                  setState(() => _profile = _profile.copyWith(mode: TradeMode.executor)),
            ),
          ],
        );
      case _Step.experience:
        return _chipStep(
          ...
          values: [AppLocalizations.of(context).expNew, 'Unter 1 Jahr', AppLocalizations.of(context).exp1to3, AppLocalizations.of(context).exp3plus],
          selected: _profile.experience,
          onSelect: (v) => setState(() => _profile = _profile.copyWith(experience: v)),
        );
      case _Step.pain:
        return _chipStep(
          key: ValueKey('pain'),
          ...
          onSelect: (v) => setState(() => _profile = _profile.copyWith(painPoint: v)),
        );
      case _Step.account:
        ...
        return _choiceStep(
          ...
          options: [
            _Opt(
              ...
              onTap: () => setState(() =>
                  _profile = _profile.copyWith(riskAppetite: RiskAppetite.conservative)),
            ),
            _Opt(
              ...
              onTap: () => setState(() =>
                  _profile = _profile.copyWith(riskAppetite: RiskAppetite.moderate)),
            ),
            _Opt(
              ...
              onTap: () => setState(() =>
                  _profile = _profile.copyWith(riskAppetite: RiskAppetite.aggressive)),
            ),
          ],
        );
      case _Step.session:
        return _choiceStep(
          ...
          options: [
            ...
            _Opt(
              ...
              onTap: () => setState(
                  () => _profile = _profile.copyWith(session: TradingSession.newYork)),
            ),
            _Opt(
      ...
      case _Step.broker:
        return _chipStep(
          ...
          values: ['VT Markets', 'IC Markets', 'FTMO', 'Vantage', AppLocalizations.of(context).brokerOther, AppLocalizations.of(context).brokerNone],
          selected: _profile.broker,
          onSelect: (v) => setState(() => _profile = _profile.copyWith(broker: v)),
        );
      ...
      child: Column(children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: Obsidian.gold.withValues(alpha: .3), width: 2),
          ),
          child: Icon(Icons.my_location_rounded, color: Obsidian.gold, size: 38),
        ),
        SizedBox(height: 28),
        Text(AppLocalizations.of(context).hookTitle,
            textAlign: TextAlign.center,
            style: TextStyle(
                fontSize: 28, fontWeight: FontWeight.w900, color: txt, height: 1.2)),
        SizedBox(height: 14),
        Text(
        ...
        if (_winRate != null || _totalSignals != null)
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            if (_totalSignals != null) _stat('$_totalSignals', AppLocalizations.of(context).statTracked, muted, txt),
            if (_totalSignals != null && _winRate != null) SizedBox(width: 28),
            if (_winRate != null)
              _stat('${_winRate!.toStringAsFixed(0)}%', AppLocalizations.of(context).histWinRate, muted, txt),
          ]),
        Spacer(),
        _primaryButton(AppLocalizations.of(context).hookCta, _next),
        SizedBox(height: 10),
        Text(AppLocalizations.of(context).hookDuration, style: TextStyle(fontSize: 12, color: muted)),
      ]),
    );
  }

  Widget _stat(String value, String label, Color muted, Color txt) => Column(children: [
        Text(value,
            style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: txt)),
  ...
  Widget _choiceStep({
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(height: 8),
        Text(title,
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: txt)),
        if (subtitle != null) ...[
          SizedBox(height: 6),
        ...
        Expanded(
          child: ListView(children: [
            for (final o in options)
              _OptionCard(opt: o, isDark: isDark),
          ]),
        ),
        _primaryButton(AppLocalizations.of(context).continueBtn, hasSelection ? _next : null),
      ]),
    );
  }
            ...
            GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Text(v,
                    style: TextStyle(
                        fontSize: 14,
                        fontWeight: selected == v ? FontWeight.w800 : FontWeight.w600,
                        color: selected == v ? Obsidian.gold : txt)),
              ),
            ),
        ]),
        Spacer(),
        _primaryButton(AppLocalizations.of(context).continueBtn, selected != null ? _next : null),
      ]),
    );
  }
  ...
  Widget _accountStep(bool isDark) {
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(height: 32),
        Text(AppLocalizations.of(context).accountSizeLabel, style: TextStyle(fontSize: 13, color: muted)),
        Text('\$${_profile.accountBalance.toStringAsFixed(0)}',
            style: TextStyle(fontSize: 34, fontWeight: FontWeight.w900, color: txt)),
        Slider(
          ...
          onChanged: (v) => setState(() =>
              _profile = _profile.copyWith(accountBalance: (v / 500).round() * 500)),
        ),
        SizedBox(height: 18),
        Text(AppLocalizations.of(context).riskPerTrade, style: TextStyle(fontSize: 13, color: muted)),
        ...
        Slider(
          ...
          onChanged: (v) => setState(() => _profile =
              _profile.copyWith(riskPercent: double.parse(v.toStringAsFixed(2)))),
        ),
        SizedBox(height: 14),
        Container(
          ...
          child: Text(
            ...
            style: TextStyle(
                fontSize: 14, fontWeight: FontWeight.w700, color: Obsidian.gold),
          ),
        ),
        Spacer(),
    ...
    return Padding(
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child:
              Icon(Icons.notifications_active_rounded, color: Obsidian.gold, size: 38),
        ),
        SizedBox(height: 28),
        Text(
          isSniper ? AppLocalizations.of(context).notifTitle : AppLocalizations.of(context).notifNever,
          textAlign: TextAlign.center,
          style: TextStyle(
              fontSize: 24, fontWeight: FontWeight.w900, color: txt, height: 1.25),
        ),
        SizedBox(height: 12),
        Text(
          isSniper
        ...
        Spacer(),
        _primaryButton(AppLocalizations.of(context).enableNotifs, _requestNotifications),
        SizedBox(height: 8),
        GestureDetector(
          onTap: _next,
          child: Padding(
            padding: EdgeInsets.all(8),
            child: Text(AppLocalizations.of(context).maybeLater, style: TextStyle(fontSize: 13, color: muted)),
          ),
        ),
      ]),
    );
  ...
  Widget _calculatingStep(bool isDark) {
    ...
    return Center(
      ...
      child: AnimatedBuilder(
        animation: _calcCtrl,
        builder: (ctx, _) {
          final idx = (_calcCtrl.value * lines.length).floor().clamp(0, lines.length - 1);
          return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(lines[idx],
                style:
                    TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: txt)),
          ]);
        },
      ),
    );
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(AppLocalizations.of(context).resultReady,
            style: TextStyle(
                ...
                letterSpacing: 1.5)),
        SizedBox(height: 8),
        Text(isSniper ? AppLocalizations.of(context).youAreSniper : AppLocalizations.of(context).youAreExecutor,
            style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: txt)),
        SizedBox(height: 20),
        Container(
          width: double.infinity,
          ...
          child: Column(children: [
            _resultRow(Icons.my_location_rounded,
                isSniper ? AppLocalizations.of(context).modeZoneLabel : AppLocalizations.of(context).modeLiveLabel,
                isSniper
            ...
            _resultRow(
                ...
                AppLocalizations.of(context).resultLadder(_profile.tpWeights.join('/')),
                AppLocalizations.of(context).resultTp1(_profile.tpWeights.first),
                txt,
                muted),
            _div(bord),
            _resultRow(
                Icons.shield_rounded,
                AppLocalizations.of(context).resultMaxRisk(_profile.riskAmount.toStringAsFixed(0)),
      ...
      Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(title,
                style:
                    TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: txt)),
            SizedBox(height: 2),
            Text(sub, style: TextStyle(fontSize: 12, color: muted, height: 1.3)),
          ]),
        ),
      ]);
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(AppLocalizations.of(context).paywallTitle,
            style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: txt)),
        SizedBox(height: 6),
        Text(AppLocalizations.of(context).paywallUnlockMode(_profile.mode == TradeMode.sniper ? 'Sniper' : 'Executor'),
        ...
        Container(
          ...
          child: Column(children: [
            _timelineRow(Icons.lock_open_rounded, AppLocalizations.of(context).tlToday, AppLocalizations.of(context).tlTodaySub,
                Obsidian.gold, txt, muted, first: true),
            _timelineRow(Icons.notifications_rounded, AppLocalizations.of(context).tlDay5,
                AppLocalizations.of(context).tlDay5Sub, Obsidian.gold, txt, muted),
            _timelineRow(Icons.star_rounded, AppLocalizations.of(context).tlDay7,
                Platform.isIOS ? AppLocalizations.of(context).tlDay7Sub:
                AppLocalizations.of(context).tlDay7SubGoogle, Obsidian.gold, txt, muted,
                last: true),
          ]),
        ),
        SizedBox(height: 10),
          ...
          child: Row(children: [
            Expanded(
              child: Text(AppLocalizations.of(context).reminderToggle,
                  style:
                      TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: txt)),
            ),
            Switch(
              value: _remindMe,
              activeColor: Obsidian.gold,
        ...
        Row(children: [
          Expanded(
            child: _planCard(
              ...
              price: annualPrice ?? '—',
              sub: perDay != null ? AppLocalizations.of(context).perDay(perDay) : AppLocalizations.of(context).bestDeal,
        ...
        for (final f in [
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              SizedBox(width: 8),
              Expanded(child: Text(f, style: TextStyle(fontSize: 13, color: txt))),
            ]),
          ),
        ...
        if (_winRate != null && _totalSignals != null) ...[
          ...
          Container(
            ...
            child: Text(
              AppLocalizations.of(context).trackRecord(_winRate!.toStringAsFixed(0), _totalSignals ?? 0, _avgRR != null ? ' · Ø ${_avgRR!.toStringAsFixed(2)}R' : ''),
        ...
        if (_error != null)
          Padding(
            ...
            child: Text(_error!,
                style: TextStyle(
                    fontSize: 12, color: Obsidian.sell, fontWeight: FontWeight.w600)),
          ),
        ...
        Center(
          child: Text(
              _yearlySelected
                  ? AppLocalizations.of(context).trialTermsYearly(annualPrice ?? '—')
                  : AppLocalizations.of(context).trialTermsMonthly(monthlyPrice ?? '—'),
              textAlign: TextAlign.center,
              style:
                  TextStyle(fontSize: 11, color: muted, fontWeight: FontWeight.w600, height: 1.4)),
        ),
        SizedBox(height: 10),
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          GestureDetector(
  ...
  Widget _timelineRow(IconData icon, String day, String text, Color accent, Color txt,
          Color muted,
      ...
      Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Column(children: [
          ...
          if (!last)
            Container(width: 2, height: 22, color: accent.withValues(alpha: .2)),
        ]),
        SizedBox(width: 12),
        Expanded(
          child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(day,
                  style:
                      TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: txt)),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 8),
          Text(price,
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: txt)),
